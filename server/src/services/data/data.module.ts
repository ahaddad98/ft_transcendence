...
@Module({
  imports: [TypeOrmModule.forFeature([User, Friend, Stats, History, Message, RequestFriend]), AuthModule],
  providers: [DataService, UserService, FriendService, StatsService, HistoryService, MessageService, RequestFriendService],
  exports: [DataService],
})
