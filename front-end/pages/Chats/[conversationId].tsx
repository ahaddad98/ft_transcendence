...
const Conversation = () => {
  ...
  return (
      ...
      {
          data && <HomeNavbar data={data}/>
      }
    <div className="container mx-auto shadow-lg rounded-lg h-inherit">
      <div className="px-5 py-5 flex justify-between items-center bg-red-700 border-b-2">
      ...
      <div className="flex flex-row justify-between bg-white">
        ...
        <div className="w-full px-5 flex flex-col justify-between bg-orange-700" >
