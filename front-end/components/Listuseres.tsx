              ...
              {/* {!click && (
                <>
                  <div className="flex w-1/2">
                    <div className="px-4 py-2 -mb-px font-semibold border-b-2 border-orange-400 rounded-t xl:text-xl text-xl text-center  font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto cursor-pointer"
                     onClick={() => {
                      setClick(!click);
                    }}>
                      <a id="default-tab" href="#first">
                    ...
                    <div className="xl:text-xl text-xl text-center text-gray-800 font-extrabold pb-6 sm:w-4/6 w-5/6 mx-auto cursor-pointer">
                      <a
                        id="default-tab"
                        href="#first"
